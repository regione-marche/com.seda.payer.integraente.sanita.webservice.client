...
public class RecuperaListDocRequest  extends com.seda.payer.integraente.webservice.dati.Request_ResponseLista  implements java.io.Serializable {
    public RecuperaListDocRequest() {
    }
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof RecuperaListDocRequest)) return false;
        RecuperaListDocRequest other = (RecuperaListDocRequest) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(RecuperaListDocRequest.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://dati.webservice.integraente.payer.seda.com", "RecuperaListDocRequest"));
    }
